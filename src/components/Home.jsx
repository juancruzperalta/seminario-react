...
'>
      ...
      <span className='bg-gray-500/20 rounded w-[30px] h-[1rem] inline-block animate-pulse'></span>
            ...
            <span className='font-semibold text-gray-200/95 text-[1rem] p-0 m-0 pt-0 pb-0 rounded-sm'>{currentSerieDetails?.origin_country?.[0] ? <span className='border-1 border-gray-300   p-[0.2rem] m-0 pt-0 pb-0 rounded-sm'>{currentSerieDetails?.origin_country?.[0]}</span>:  (
      <span className='bg-gray-500/20 rounded w-[30px] h-[1rem] inline-block animate-pulse'></span>
    )}</span>
